...
import 'package:skiome_centres/achievementsScreens/achievements_ui_design_widget.dart';
import 'package:skiome_centres/achievementsScreens/upload_achievements_screen.dart';
...
import 'package:skiome_centres/models/achievements.dart';
          ...
          IconButton(
              onPressed: () {
                Navigator.push(
                    ...
                    MaterialPageRoute(
                        builder: ((context) =>
                            UploadAchievementScreens(model: widget.model))));
              },
              icon: Icon(
                Icons.add,
                color: Colors.white,
