...
import 'package:skiome_centres/competitionsScreens/competition_registration.dart';
import 'package:skiome_centres/competitionsScreens/competitons_ui_design_widget.dart';
          ...
          IconButton(
              onPressed: () {
                Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (c) => CompetitionRegistrationPage()));
              },
              icon: Icon(
              ...
              if (dataSnapshot.hasData) //if categoies exist
              {
                ...
                return SliverStaggeredGrid.countBuilder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return CompetitionsUiDesignWidget(
                      model: eventsModel,
                      context: context,
                    );
                  },
