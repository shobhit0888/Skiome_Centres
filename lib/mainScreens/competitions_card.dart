...
class CompetitonsCardWidget extends StatefulWidget {
  @override
  State<CompetitonsCardWidget> createState() => _EventsCardWidgetState();
}

class _EventsCardWidgetState extends State<CompetitonsCardWidget> {
  @override
